...
import { IllustrationCvBuilder, IllustrationLetterWriter, IllustrationInterviewPrep } from './icons';
...
export default function HomeScreen({ setMode }: HomeScreenProps): React.ReactNode {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-slate-50 dark:bg-slate-900 p-8 text-center">
      <div className="mb-12">
