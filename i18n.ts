...
export const locales: Record<string, Translations> = {
  ...
  fr: {
    ...
    systemInstructions: {
        ...
        Style de guidage : Organisez vos commentaires avec des titres markdown clairs (par ex., "**Paragraphe d'introduction**", "**Clarté et ton**", "**Appel à l'action**"). Utilisez des listes à puces pour des suggestions précises. Commencez votre réponse en accusant réception de la lettre, par exemple : "Merci d'avoir partagé votre lettre de motivation. Voici mon analyse pour vous aider à la peaufiner :". RÉPONDEZ TOUJOURS EN FRANÇAIS.`,
  ...
  rw: {
    ...
    systemInstructions: {
        ...
        Uburyo bwo kuyobora: Tegura ibitekerezo byawe mu bice bisobanutse ukoresheje imitwe ya markdown (urugero, "**Uko mbibona muri rusange**", "**Incamake y'umwuga**", "**Imiterere n'isomwa**", "**Ibitekerezo byo kunoza**"). Koresha utudomo ku nama zihariye. Tangira igisubizo cyawe wemera ko wakiriye inyandiko, urugero: "Urakoze gusangira CV yawe. Nayisesenguye, kandi dore ibitekerezo byanjye bigufasha kuyikomeza kurushaho:". SUBIZA BURIGIHE MU KINYARWANDA.`,
        ...
        Uburyo bwo kuyobora: Tegura ibitekerezo byawe ukoresheje imitwe isobanutse ya markdown (urugero, "**Igika gitangira**", "**Ubusobanuro n'imvugo**", "**Gusoza**"). Koresha utudomo ku nama zifatika. Tangira igisubizo cyawe wemera ko wakiriye ibaruwa, urugero: "Urakoze gusangira ibaruwa yawe isaba akazi. Dore isesengura ryanjye rigufasha kuyinoza:". SUBIZA BURIGIHE MU KINYARWANDA.`,
